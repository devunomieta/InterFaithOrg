    ...
    <div>
      <header className={styles.pageHeader}>
        <div className="container">
          <h1>Who We Are</h1>
          <p style={{ opacity: 0.8, maxWidth: '600px', margin: '0 auto', fontSize: '1.1rem' }}>Learn simple details about our journey, who we are, and what we plan to do.</p>
        </div>
      </header>
      ...
      <main className="container">
        ...
        <section className={styles.gridSplit11} style={{ padding: '6rem 0' }}>
          ...
          <div>
            ...
            <p style={{ lineHeight: 1.8, fontSize: '1.1rem', color: 'var(--color-muted)', marginBottom: '1.5rem' }}>
              Back in 2010, during a period of frequent crises and heavy fighting in our communities, our small group of locals came together with help from the Interfaith Center in Kaduna to find a way to bring the people together and end the violence.
            </p>
            <p style={{ lineHeight: 1.8, fontSize: '1.1rem', color: 'var(--color-muted)' }}>
              We grew from being just young a mbassadors into a fully coordinated body. Finally in 2024, we completed our long wait and became a legally registered organization with the Corporate Affairs Commission (CAC).
            </p>
          </div>
        </section>
        ...
        <section className={`${styles.gridSplit11} ${styles.paddedBox}`} style={{ backgroundColor: 'var(--color-primary)', color: 'white', marginBottom: '4rem' }}>
          <div>
            ...
            <p style={{ opacity: 0.8, fontSize: '1.1rem', marginTop: '1rem' }}>
              To see a peaceful community where fighting stops and everyone has simple opportunities to earn a basic living.
            </p>
          </div>
          <div>
            <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>🎯</div>
        ...
        <section className="section-padding">
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            <span style={{ color: 'var(--color-secondary)', fontWeight: 800, letterSpacing: '2px', textTransform: 'uppercase', fontSize: '0.85rem' }}>Our Board</span>
            <h2 style={{ fontSize: '2.5rem' }}>Our Board of Trustees</h2>
          </div>
