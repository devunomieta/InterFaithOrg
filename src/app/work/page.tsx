    ...
    <div>
      <header className={styles.pageHeader}>
        <div className="container">
          <h1>Our Actions</h1>
          <p style={{ opacity: 0.8, maxWidth: '600px', margin: '0 auto', fontSize: '1.1rem' }}>Simple things we do to make communities peaceful.</p>
        </div>
      </header>
        ...
        <div className={styles.gridSplit21} style={{ marginBottom: '6rem' }}>
          <div>
            ...
            <p style={{ marginBottom: '2.5rem', fontSize: '1.1rem', color: 'var(--color-muted)' }}>
              Since becoming registered, we have spent our time doing some simple, useful things for the people.
            </p>
        ...
        <div className={styles.gridSplit12}>
          ...
          <div>
            ...
            <div className={styles.subGrid2}>
              <div>
                <h4 style={{ marginBottom: '0.5rem' }}>1. Checking</h4>
                <p style={{ fontSize: '0.85rem', color: 'var(--color-muted)' }}>Local elders double-check which families really need help the most.</p>
              </div>
              <div>
                <h4 style={{ marginBottom: '0.5rem' }}>2. Moving Safe</h4>
